...
The tool installs to: C:\ProgramData\Autodesk\ApplicationPlugins\
Log files saved to: C:\VISIBILITY EXPORT_IMPORT\
...
Click the IB-BIM tab in Revit ribbon
Click Visibility Manager button

Method 2: From Add-Ins Tab

Click Add-Ins tab
Look for External Tools section
Click Visibility Manager

Note: You must have a view open in Revit. The tool uses the currently active view.
...
!![Filters Mode Interface](Docs/Images/Filter%20Screen.png)
*Figure 1: Filters mode interface – showing the active Filters panel (green).*

![VG Overrides Interface](Docs/Images/VG%20Screen.png)
...
**Debug Log:**
```
C:\VISIBILITY EXPORT_IMPORT\Filters_Debug.log
```
